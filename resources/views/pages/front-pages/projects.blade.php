   ...
   <div class="container ">
       ...
       <div class="row " id="projects-listing">
           @foreach($projects as $project)
               <div class="card mr-2"
                    style="width: 12rem;height: 16rem; background: url({{ '/storage/projects/images/' . $project->image }}) no-repeat;background-size: cover; object-position: center;object-fit: cover">
