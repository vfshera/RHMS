            ...
            @foreach($showcases as $showcase)
                <div class="card mr-2"
                    ...
                    <div  style="background: rgba(255,255,255,.7);position: absolute;height:50px;bottom: 0;left: 0;right: 0;display: flex;flex-direction:column;align-items: center">
                        ...
                        <span style="display: flex;cursor:pointer;justify-content: center;align-items: center;font-size: larger;font-weight: bolder;height: 30px;color: white;background-color: red;padding: 5px 30px; border-radius: 5px">
